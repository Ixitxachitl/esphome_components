...
class MFRC522I2C : public rc522::RC522, public i2c::I2CDevice {
 public:
  void setup() override;   // Ensure setup() is defined
  void loop() override;    // Ensure loop() is defined
 ...
 protected:
  // Ensure these virtual functions are correctly declared and implemented
